...
<subhead>A closer look at Houston auto thefts by neighborhood</subhead>
...
autotheftpal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), autothefts_beat$rate_last12, bins = autotheftbins1,na.color = "#51585f")

autotheftpal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), autothefts_beat$last12mos, bins = autotheftbins2,na.color = "#51585f")

# Create quick labels for autothefts map
autotheftlabel <- paste(sep="",
                     "<popuptitle>",
                     autothefts_beat$last12mos,
                     " auto thefts </popuptitle><br>",
...
"</td>
				<td>",
prettyNum(round(autothefts_beat$rate19,0),big.mark =","),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
prettyNum(round(autothefts_beat$rate20,0),big.mark =","),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
prettyNum(round(autothefts_beat$rate21,0),big.mark =","),
"</td>
			</tr>
						<tr>
...
"</td>
				<td>",
prettyNum(round(autothefts_beat$rate_last12,0),big.mark =","),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(autothefts_beat$avg_prior3years,0),
"</td>
				<td>",
prettyNum(round(autothefts_beat$rate_prior3years,0),big.mark =","),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
houston_autotheft_map <- leaflet(autothefts_beat, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
