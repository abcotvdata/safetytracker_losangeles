...
theftpal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), thefts_beat$rate_last12, bins = theftbins1,na.color = "#51585f")

theftpal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), thefts_beat$last12mos, bins = theftbins2,na.color = "#51585f")

# Create quick labels for thefts map
theftlabel <- paste(sep="",
                     "<popuptitle>",
                     prettyNum(thefts_beat$last12mos, big.mark=","),
...
"</td>
				<td>",
prettyNum(round(thefts_beat$rate19,0), big.mark=","),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
prettyNum(round(thefts_beat$rate20,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
prettyNum(round(thefts_beat$rate21,0), big.mark=","),
"</td>
			</tr>
						<tr>
...
"</td>
				<td>",
prettyNum(round(thefts_beat$rate_last12,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(thefts_beat$avg_prior3years,0),
"</td>
				<td>",
prettyNum(round(thefts_beat$rate_prior3years,0), big.mark=","),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
houston_theft_map <- leaflet(thefts_beat, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
  htmlwidgets::onRender("function(el, x) {
L.control.zoom({ position: 'topright' }).addTo(this)
}") %>%
  setView(-95.45, 29.75, zoom = 10.5) %>% 
  addProviderTiles(provider = "CartoDB.Positron") %>%
  setMaxBounds( lng1 = -93
                 , lat1 = 27
                 , lng2 = -97
                 , lat2 = 31) %>%
  ...
  addLegend(opacity = 0.6,
            values = thefts_beat$rate_last12, 
            pal = theftpal1,
            position = "bottomleft", 
