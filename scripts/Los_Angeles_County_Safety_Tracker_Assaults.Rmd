...
There were <h8>`r prettyNum(assaults_county$total22,big.mark=",")`</h8> aggravated assaults in 2022 across Los Angeles County, according to data that law enforcement agencies report to the state of California.
...
assaultpal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), socal_assault$`2022`, bins = assaultbins2,na.color = "#76baf9")
...
"</td>
				...
				<td>2022</td>
				<td>",
prettyNum(socal_assault$`2022`, big.mark=","),
"</td>
				<td>",
prettyNum(socal_assault$rate22, big.mark=","),
"</td>
			</tr>
						<tr>
				<td>4-year Average</td>
				<td>",
prettyNum(socal_assault$avg_prior4years, big.mark=","),
"</td>
				<td>",
prettyNum(socal_assault$rate_prior4years, big.mark=","),
"</td>
			</tr>
</table>",
