...
There were <h8>`r prettyNum(burglaries_county$total22,big.mark=",")`</h8> burglaries in 2022 across Los Angeles County, according to data that law enforcement agencies report to the state of California.
...
burglarypal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), socal_burglary$`2022`, bins = burglarybins2,na.color = "#51585f")
...
"</td>
				<td>",
socal_burglary$rate22,
"</td>
			</tr>
						<tr>
				<td>4-year Average</td>
				<td>",
socal_burglary$avg_prior4years,
"</td>
				<td>",
socal_burglary$rate_prior4years,
"</td>
			</tr>
</table>",
