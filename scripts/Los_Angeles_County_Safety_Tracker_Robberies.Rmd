...
There were <h8>`r prettyNum(robberies_county$total22,big.mark=",")`</h8> robberies in 2022 across Los Angeles County, according to data that law enforcement agencies report to the state of California.
...
robberypal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), socal_robbery$`2022`, bins = robberybins2,na.color = "#76baf9")
...
"</td>
				<td>",
socal_robbery$rate22,
"</td>
			</tr>
						<tr>
				<td>4-year Average</td>
				<td>",
socal_robbery$avg_prior4years,
"</td>
				<td>",
socal_robbery$rate_prior4years,
"</td>
			</tr>
</table>",
