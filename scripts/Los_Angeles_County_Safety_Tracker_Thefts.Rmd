...
There were <h8>`r prettyNum(thefts_county$total22,big.mark=",")`</h8> larceny thefts in 2022 across Los Angeles County, according to data that law enforcement agencies report to the state of California.
...
theftpal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), socal_theft$`2022`, bins = theftbins2,na.color = "#76baf9")
...
"</td>
				...
				<td>",
socal_theft$avg_prior4years,
"</td>
				<td>",
socal_theft$rate_prior4years,
"</td>
			</tr>
</table>",
