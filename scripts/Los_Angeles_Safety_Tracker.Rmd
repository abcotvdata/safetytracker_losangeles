...
<br>
Homicides over the last 12 months are trending <h8>`r ifelse(murders_city$inc_21tolast12>=0," up"," down")` `r ifelse(murders_city$inc_21tolast12>=0,murders_city$inc_21tolast12,substring(murders_city$inc_21tolast12,2))`%</h8> compared to 2021, according to the Los Angeles Police Department and Los Angeles County Sheriff's Department data through `r format(asofdate, "%B %d")`.

However, the murder rate in the areas of the county policed by the LAPD and Sheriff's Department over the last 12 months is <h8>`r case_when((murders_city$rate_last12-murders_city$rate_prior3years)>=0.25 ~ "up",
...
The Los Angeles area averaged about <h8>`r round(murders_city$last12mos/12,0)`</h8> homicides a month over the last year. In 2019, that number was <h8>`r round(murders_city$total19/12,0)`</h8> a month.

One way to think about the danger: three years ago, the murder rate in the area was <h8>`r murders_city$rate19`</h8> per 100,000 residents. That's higher than the risk of dying in a vehicle crash in California. The area's murder rate has jumped to <h8>`r murders_city$rate_last12`</h8> over the last 12 months.
<br>
<br>
<!-- <subhead>Risk of being murdered in Los Angeles vs. other causes of death in Harris County</subhead> -->

<iframe title="Current risk of homicide in LA area vs. other causes of death" aria-label="Bar Chart" id="datawrapper-chart-DHBJ9" src="https://datawrapper.dwcdn.net/DHBJ9/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="402" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>

The risk is not the same neighborhood to neighborhood.

ABC7's data team looked at data from the Los Angeles Police Department and Los Angeles County Sheriff's Department by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`, the latest date for which records are available from the two agencies. Totals here include murders, but not involuntary manslaughter or justifiable homicide.
