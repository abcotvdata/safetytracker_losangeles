...
The murder rate in the areas of the county policed by the LAPD and Sheriff's Department over the last 12 months is <h8>`r case_when((murders_city$rate_last12-murders_city$rate_prior3years)>=0.25 ~ "up",
