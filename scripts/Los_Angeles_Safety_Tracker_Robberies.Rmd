...
robberypal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), robberies_beat$rate_last12, bins = robberybins1,na.color = "#51585f")

robberypal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), robberies_beat$last12mos, bins = robberybins2,na.color = "#51585f")
...
<iframe title="Robberies month by month, 2019 through last month" aria-label="Column Chart" id="datawrapper-chart-6BRuf" src="https://datawrapper.dwcdn.net/6BRuf/2/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
  ...
  <br>
<br>
<!-- <subhead>Risk of robbery and other violent crimes in Houston </subhead> -->
