...
<bignumber>`r prettyNum(round(shootings_city$avg_prior4years,0), big.mark=",")`<br></bignumber><p>
...
<bignumber>`r round(shootings_city$rate_prior4years,0)`<br></bignumber><p>
Per 100,000 people<br>2019 to 2022</p>
</div>
</div>
<br>
Shootings over the last 12 months are <h8>`r ifelse(shootings_city$inc_prior4yearavgtolast12>=0," up"," down")` `r ifelse(shootings_city$inc_prior4yearavgtolast12>=0,shootings_city$inc_prior4yearavgtolast12,substring(shootings_city$inc_prior4yearavgtolast12,2))`%</h8> compared to the annual average over the last four years, according to the latest Los Angeles Police Department data through `r format(lapd_asofdate, "%B %d")`.
...
"</td>
				...
				<td>2022</td>
				<td>",
shootings_district$`2022`,
"</td>
				<td>",
round(shootings_district$rate22,0),
"</td>
			</tr>
						<tr>
				<td>2023</td>
				<td>",
shootings_district$`2023`,
"</td>
				<td>",
round(shootings_district$rate23,0),
"</td>
			</tr>
						<tr>
...
"</td>
				...
				<td>",
round(shootings_district$avg_prior4years,0),
"</td>
				<td>",
round(shootings_district$rate_prior4years,0),
"</td>
			</tr>
</table>")
