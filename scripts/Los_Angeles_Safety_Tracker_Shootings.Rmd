...
The map color codes each police district by the shooting rate over the last 12 months. The three darker blues represent neighborhoods with shooting rates that are higher than the citywide rate. You can also click the box in the bottom right corner to see neighborhoods by the number of shootings.
...
shootingbins2 <- c(0,
                ...
                100,
                300)
shootingpal1 <- colorBin(c("#aecfe6",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), shootings_district$rate_last12, bins = shootingbins1,na.color = "#51585f")

shootingpal2 <- colorBin(c("#aecfe6",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), shootings_district$last12mos, bins = shootingbins2,na.color = "#51585f")


# Create quick labels for shootings map
shootinglabel <- paste(sep="",
                     "<popuptitle>",
...
losangeles_shooting_map <- leaflet(shootings_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addPolygons(color = "white", 
              ...
              opacity = 0.6, 
              fillOpacity = 0.6,
              fillColor = ~shootingpal1(rate_last12),
              group="Rate") %>% 
    addPolygons(color = "white", 
              popup = shootinglabel,
              popupOptions = popupOptions(maxWidth ="200", 
              ...
              opacity = 0.6, 
              fillOpacity = 0.6,
              fillColor = ~shootingpal2(last12mos),
              group="Number") %>% 
  ...
  addLegend(opacity = 0.6,
            ...
            pal = shootingpal1,
            position = "bottomleft", 
            title = paste(sep="","<popuptitle>Shooting Rate<br><popupchatter>Shootings/100K people<br>Citywide: ",prettyNum(round(shootings_city$rate_last12,0), big.mark=",")),
            group = "Rate",
...
losangeles_shooting_map
```
<br>
<br>
<!-- <subhead>Shootings year by year, 2019 through last month</subhead> -->
<iframe title="Shootings year by year in Los Angeles" aria-label="Column Chart" id="datawrapper-chart-p0Awq" src="https://datawrapper.dwcdn.net/p0Awq/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
<br>
