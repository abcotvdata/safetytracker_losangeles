...
<h2>ABC7 is tracking crime and safety across the city of Oakland and in your neighborhood. 
...
<subhead>Oakland thefts neighborhood by neighborhood</subhead>

The risk is not the same neighborhood to neighborhood. ABC7's data team looked at the Oakland Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
oakland_theft_map <- leaflet(thefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
