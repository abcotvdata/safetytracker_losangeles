...
![<popupchatter>Updated `r format(Sys.time(), '%B %d, %Y')` by the ABC7 Data Team</popupchatter>](https://github.com/abcotvdata/safetytracker_losangeles/raw/main/docs/banner_kgo.png)
...
The risk is not the same neighborhood to neighborhood. ABC7's data team looked at the Los Angeles Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
