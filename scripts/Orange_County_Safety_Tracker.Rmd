...
In 2019, the data show that number was <h8>`r prettyNum(murders_county$total19,big.mark=",")`</h8>. In 2010, it was `r prettyNum(murders_county$total10,big.mark=",")`</h8>.
...
murderpal1 <- colorBin(c("#aecfe6",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), murders_places$rate21, bins = murderbins1,na.color = "#51585f")

murderpal2 <- colorBin(c("#aecfe6",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), murders_places$total21, bins = murderbins2,na.color = "#51585f")

                            
# Create labels for murders map
murderlabel_places <- paste(sep="",
                     "<popuptitle>",
                     murders_places$total21,
                     ifelse(murders_places$total21==1,
                     " homicide </popuptitle><br>",
                     " homicides </popuptitle><br>"),
                     " in 2021 in <b>",
                     murders_places$place,
                     "</b> home to an estimated ",
                     prettyNum(murders_places$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
murders_places$total19,
"</td>
				<td>",
murders_places$rate19,
"</td>
			</tr>
			<tr>
				<td>2020</td>
				<td>",
murders_places$total20,
"</td>
				<td>",
murders_places$rate20,
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
murders_places$rate21,
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
murders_places$avg_prior3years,
"</td>
				<td>",
murders_places$rate_prior3years,
"</td>
			</tr>
</table>")
...
orange_murder_map <- leaflet(murders_places, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
  htmlwidgets::onRender("function(el, x) {
L.control.zoom({ position: 'topright' }).addTo(this)
}") %>%
  setView(-117.8, 33.67, zoom = 11) %>% 
