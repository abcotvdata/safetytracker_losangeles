...
There were <h8>`r prettyNum(assaults_county$total22,big.mark=",")`</h8> aggravated assaults in 2022 across Orange County, according to data that law enforcement agencies report to the state of California.
