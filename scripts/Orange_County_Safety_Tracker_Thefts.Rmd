...
There were <h8>`r prettyNum(thefts_county$total22,big.mark=",")`</h8> larceny thefts in 2022 across Orange County, according to data that law enforcement agencies report to the state of California.
