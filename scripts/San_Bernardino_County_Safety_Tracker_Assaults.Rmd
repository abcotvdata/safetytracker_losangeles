...
There were <h8>`r prettyNum(assaults_county$total22,big.mark=",")`</h8> aggravated assaults in 2022 across San Bernardino County, according to data that law enforcement agencies report to the state of California.
...
assaultpal2 <- colorBin(c("#76baf9",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), socal_assault$`2022`, bins = assaultbins2,na.color = "#51585f")
