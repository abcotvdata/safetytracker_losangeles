...
There were <h8>`r prettyNum(burglaries_county$total22,big.mark=",")`</h8> burglaries in 2022 across San Bernardino County, according to data that law enforcement agencies report to the state of California.
