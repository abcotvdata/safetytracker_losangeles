...
<br>
<br>
There were <h8>`r round(assaults_region$last12mos/12,0)`</h8> aggravated assaults a month in 2021 across every Southern California police jurisdiction, according to data that law enforcement agencies report to the state of Californina. In 2019, the data show that number was <h8>`r round(assaults_region$total19/12,0)`</h8> a month.
...
<subhead>A closer look at Southern California aggravated assaults where you live</subhead>
...
assaultpal1 <- colorBin(c("#aecfe6",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), assaults_region$rate21, bins = assaultbins1,na.color = "#51585f")

assaultpal2 <- colorBin(c("#aecfe6",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), assaults_region$total21, bins = assaultbins2,na.color = "#51585f")


# Create quick labels for assaults map
assaultlabel <- paste(sep="",
                     "<popuptitle>",
                     prettyNum(assaults_region$total21, big.mark=","),
                     " assaults </popuptitle><br>",
                     " in 2021 in <b>",
                     assaults_region$place,
                     "</b> home to an estimated ",
                     prettyNum(assaults_region$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
assaults_region$total19,
"</td>
				<td>",
prettyNum(round(assaults_region$rate19,0), big.mark=","),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
prettyNum(round(assaults_region$rate20,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
prettyNum(round(assaults_region$rate21,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(assaults_region$avg_prior3years,0),
"</td>
				<td>",
prettyNum(round(assaults_region$rate_prior3years,0), big.mark=","),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
socal_assault_map <- leaflet(assaults_region, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = assaults_region$rate21, 
            pal = assaultpal1,
            position = "bottomleft", 
            title = paste(sep="","<popuptitle>Assault Rate<br><popupchatter>Aggravated assaults/100K people",
            group = "Rate",
            className = "info legend Rate") %>%
  addLegend(opacity = 0.6,
            values = assaults_region$total21, 
            pal = assaultpal2,
            position = "bottomleft", 
            title = paste(sep="","<popuptitle>Assaults<br><popupchatter>Total assaults",
            group = "Number",
