...
<br>
<br>
There were <h8>`r round(burglaries_region$last12mos/12,0)`</h8> burglaries a month in 2021 across every Southern California police jurisdiction, according to data that law enforcement agencies report to the state of Californina. In 2019, the data show that number was <h8>`r round(burglaries_region$total19/12,0)`</h8> a month.
...
<subhead>A closer look at Southern California burglaries where you live</subhead>
...
The map color codes each community by the burglary rate in 2021. You can also click the box in the bottom right corner to see neighborhoods by the number of burglaries.
...
burglarypal1 <- colorBin(c("#aecfe6",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), burglaries_region$rate_last12, bins = burglarybins1,na.color = "#51585f")

burglarypal2 <- colorBin(c("#aecfe6",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), burglaries_region$last12mos, bins = burglarybins2,na.color = "#51585f")


# Create quick labels for burglaries map
burglarylabel <- paste(sep="",
                     "<popuptitle>",
                     burglaries_region$last12mos,
                     " burglaries </popuptitle><br>",
                     " in 2021 in <b>",
                     burglaries_region$place,
                     "</b> home to an estimated ",
                     prettyNum(burglaries_region$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
burglaries_region$total19,
"</td>
				<td>",
round(burglaries_region$rate19,0),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
round(burglaries_region$rate20,0),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
round(burglaries_region$rate21,0),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(burglaries_region$avg_prior3years,0),
"</td>
				<td>",
round(burglaries_region$rate_prior3years,0),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
socal_burglary_map <- leaflet(burglaries_region, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = burglaries_region$rate_last12, 
            pal = burglarypal1,
            position = "bottomleft", 
  ...
  addLegend(opacity = 0.6,
            values = burglaries_region$last12mos, 
            pal = burglarypal2,
            position = "bottomleft", 
...
```
<br>
<iframe title="Burglaries by area across Southern California" aria-label="Table" id="datawrapper-chart-QCckq" src="https://datawrapper.dwcdn.net/QCckq/1/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="3289" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
