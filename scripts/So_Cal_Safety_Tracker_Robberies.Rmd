...
<br>
<br>
There were <h8>`r round(robberies_region$last12mos/12,0)`</h8> aggravated assaults a month in 2021 across every Southern California police jurisdiction, according to data that law enforcement agencies report to the state of Californina. In 2019, the data show that number was <h8>`r round(robberies_region$total19/12,0)`</h8> a month.
...
<subhead>A closer look at Southern California robberies where you live</subhead>
...
The map color codes each community by the robbery rate in 2021. You can also click the box in the bottom right corner to see neighborhoods by the number of robberies.
...
robberypal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), robberies_region$rate_last12, bins = robberybins1,na.color = "#51585f")

robberypal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), robberies_region$last12mos, bins = robberybins2,na.color = "#51585f")


# Create quick labels for robberies map
robberylabel <- paste(sep="",
                     "<popuptitle>",
                     robberies_region$last12mos,
                     " robberies </popuptitle><br>",
                     " in 2021 in <b>",
                     robberies_region$place,
                     "</b> home to an estimated ",
                     prettyNum(robberies_region$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
robberies_region$total19,
"</td>
				<td>",
round(robberies_region$rate19,0),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
round(robberies_region$rate20,0),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
round(robberies_region$rate21,0),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(robberies_region$avg_prior3years,0),
"</td>
				<td>",
round(robberies_region$rate_prior3years,0),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
socal_robbery_map <- leaflet(robberies_region, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = robberies_region$rate_last12, 
            pal = robberypal1,
            position = "bottomleft", 
  ...
  addLegend(opacity = 0.6,
            values = robberies_region$last12mos, 
            pal = robberypal2,
            position = "bottomleft", 
...
```
<br>
<iframe title="Robberies by area across Southern California" aria-label="Table" id="datawrapper-chart-6EZDx" src="https://datawrapper.dwcdn.net/6EZDx/3/" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="3279" data-external="1"></iframe><script type="text/javascript">!function(){"use strict";window.addEventListener("message",(function(e){if(void 0!==e.data["datawrapper-height"]){var t=document.querySelectorAll("iframe");for(var a in e.data["datawrapper-height"])for(var r=0;r<t.length;r++){if(t[r].contentWindow===e.source)t[r].style.height=e.data["datawrapper-height"][a]+"px"}}}))}();
</script>
<br>
