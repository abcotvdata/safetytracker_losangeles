...
<br>
<br>
There were <h8>`r round(thefts_region$last12mos/12,0)`</h8> larcenies a month in 2021 across every Southern California police jurisdiction, according to data that law enforcement agencies report to the state of Californina. In 2019, the data show that number was <h8>`r round(thefts_region$total19/12,0)`</h8> a month.
...
<subhead>A closer look at Southern California thefts where you live</subhead>
...
theftpal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), thefts_region$rate_last12, bins = theftbins1,na.color = "#51585f")

theftpal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), thefts_region$last12mos, bins = theftbins2,na.color = "#51585f")

# Create quick labels for thefts map
theftlabel <- paste(sep="",
                     "<popuptitle>",
                     prettyNum(thefts_region$last12mos, big.mark=","),
                     " thefts </popuptitle><br>",
                     " in 2021 in <b>",
                     thefts_region$place,
                     "</b> home to an estimated ",
                     prettyNum(thefts_region$population, big.mark=","),
                     " people.
<br>
<table>      
      <tr>
			...
			<tr>
				<td>2019</td>
				<td>",
thefts_region$total19,
"</td>
				<td>",
prettyNum(round(thefts_region$rate19,0), big.mark=","),
"</td>
			</tr>
			<tr>
				<td>2020</td>
...
"</td>
				<td>",
prettyNum(round(thefts_region$rate20,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>2021</td>
...
"</td>
				<td>",
prettyNum(round(thefts_region$rate21,0), big.mark=","),
"</td>
			</tr>
						<tr>
				<td>3-year Average</td>
				<td>",
round(thefts_region$avg_prior3years,0),
"</td>
				<td>",
prettyNum(round(thefts_region$rate_prior3years,0), big.mark=","),
"</td>
			</tr>
</table>")

# Creating police beats map for types of crimes
socal_theft_map <- leaflet(thefts_region, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = thefts_region$rate_last12, 
            pal = theftpal1,
            position = "bottomleft", 
  ...
  addLegend(opacity = 0.6,
            values = thefts_region$last12mos, 
            pal = theftpal2,
            position = "bottomleft", 
