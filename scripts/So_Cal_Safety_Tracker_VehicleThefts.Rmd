...
<br>
<br>
There were <h8>`r round(autothefts_region$last12mos/12,0)`</h8> vehicles stolen a month in 2021 across every Southern California police jurisdiction, according to data that law enforcement agencies report to the state of Californina. In 2019, the data show that number was <h8>`r round(autothefts_region$total19/12,0)`</h8> a month.
...
autotheftpal1 <- colorBin(c("#99a0a5",
                             ...
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), autothefts_region$rate_last12, bins = autotheftbins1,na.color = "#51585f")

autotheftpal2 <- colorBin(c("#99a0a5",
                             "#2787d6",
                             "#0058f6",
                             "#003ca6",
                             "#00215c"), autothefts_region$last12mos, bins = autotheftbins2,na.color = "#51585f")

# Create quick labels for autothefts map
autotheftlabel <- paste(sep="",
                     "<popuptitle>",
                     autothefts_region$last12mos,
...
L.control.zoom({ position: 'topright' }).addTo(this)
  ...
  addLegend(opacity = 0.6,
            values = autothefts_region$rate_last12, 
            pal = autotheftpal1,
            position = "bottomleft", 
  ...
  addLegend(opacity = 0.6,
            values = autothefts_region$last12mos, 
            pal = autotheftpal2,
            position = "bottomleft", 
