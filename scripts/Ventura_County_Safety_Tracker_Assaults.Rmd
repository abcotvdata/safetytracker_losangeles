...
There were <h8>`r prettyNum(assaults_county$total22,big.mark=",")`</h8> aggravated assaults in 2022 across Ventura County, according to data that law enforcement agencies report to the state of California.
...
"</td>
				<td>",
socal_assault$rate22,
"</td>
			</tr>
						<tr>
				<td>4-year Average</td>
				<td>",
socal_assault$avg_prior4years,
"</td>
				<td>",
socal_assault$rate_prior4years,
"</td>
			</tr>
</table>",
