...
There were <h8>`r prettyNum(sexassaults_county$total22,big.mark=",")`</h8> sexual assaults in 2022 across Ventura County, according to data that law enforcement agencies report to the state of California.
