...
asofdate <- readRDS("scripts/rds/asofdate.rds")
# Render page
rmarkdown::render('scripts/Los_Angeles_Safety_Tracker_AutoThefts.Rmd', 
                  output_dir = "docs",
                  output_file = 'Los_Angeles_Safety_Tracker_AutoThefts.html')
...
# DRUG CRIMES
# Load RDS
drugs_district <- readRDS("scripts/rds/drugs_district.rds")
drugs_city <- readRDS("scripts/rds/drugs_city.rds")
asofdate <- readRDS("scripts/rds/asofdate.rds")
# Render page
rmarkdown::render('scripts/Los_Angeles_Safety_Tracker_DrugCrimes.Rmd',
                  output_dir = "docs",
                  output_file = 'Los_Angeles_Safety_Tracker_DrugCrimes.html')
