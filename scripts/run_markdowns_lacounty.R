...
rmarkdown::render('scripts/Los_Angeles_County_Safety_Tracker.Rmd', 
                  output_dir = "docs",
                  output_file = 'Los_Angeles_County_Safety_Tracker.html')
...
rmarkdown::render('scripts/Los_Angeles_County_Safety_Tracker_Burglaries.Rmd', 
                  output_dir = "docs",
                  output_file = "Los_Angeles_County_Safety_Tracker_Burglaries.html")
...
rmarkdown::render('scripts/Los_Angeles_County_Safety_Tracker_Thefts.Rmd', 
                  output_dir = "docs",
                  output_file = 'Los_Angeles_County_Safety_Tracker_Thefts.html')
...
rmarkdown::render('scripts/Los_Angeles_County_Safety_Tracker_VehicleThefts.Rmd', 
                  output_dir = "docs",
                  output_file = 'Los_Angeles_County_Safety_Tracker_VehicleThefts.html')
...
rmarkdown::render('scripts/Los_Angeles_County_Safety_Tracker_Robberies.Rmd', 
                  output_dir = "docs",
                  output_file = 'Los_Angeles_County_Safety_Tracker_Robberies.html')
...
rmarkdown::render('scripts/Los_Angeles_County_Safety_Tracker_Assaults.Rmd', 
                  output_dir = "docs",
                  output_file = 'Los_Angeles_County_Safety_Tracker_Assaults.html')
...
rmarkdown::render('scripts/Los_Angeles_County_Safety_Tracker_SexualAssaults.Rmd', 
                  output_dir = "docs",
                  output_file = 'Los_Angeles_County_Safety_Tracker_SexualAssaults.html')
