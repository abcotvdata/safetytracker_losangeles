...
# RIVERSIDE
socal_murder %>% st_drop_geometry() %>% filter(county=="Riverside County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/riverside_murder.csv")
socal_sexassault %>% st_drop_geometry() %>% filter(county=="Riverside County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/riverside_sexassault.csv")
socal_assault %>% st_drop_geometry() %>% filter(county=="Riverside County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/riverside_assault.csv")
socal_robbery %>% st_drop_geometry() %>% filter(county=="Riverside County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/riverside_robbery.csv")
socal_burglary %>% st_drop_geometry() %>% filter(county=="Riverside County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/riverside_burglary.csv")
socal_theft %>% st_drop_geometry() %>% filter(county=="Riverside County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/riverside_theft.csv")
socal_autotheft %>% st_drop_geometry() %>% filter(county=="Riverside County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/riverside_autotheft.csv")
# ORANGE
socal_murder %>% st_drop_geometry() %>% filter(county=="Orange County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/orange_murder.csv")
socal_sexassault %>% st_drop_geometry() %>% filter(county=="Orange County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/orange_sexassault.csv")
socal_assault %>% st_drop_geometry() %>% filter(county=="Orange County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/orange_assault.csv")
socal_robbery %>% st_drop_geometry() %>% filter(county=="Orange County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/orange_robbery.csv")
socal_burglary %>% st_drop_geometry() %>% filter(county=="Orange County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/orange_burglary.csv")
socal_theft %>% st_drop_geometry() %>% filter(county=="Orange County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/orange_theft.csv")
socal_autotheft %>% st_drop_geometry() %>% filter(county=="Orange County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/orange_autotheft.csv")
# RIVERSIDE
socal_murder %>% st_drop_geometry() %>% filter(county=="San Bernardino County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/sb_murder.csv")
socal_sexassault %>% st_drop_geometry() %>% filter(county=="San Bernardino County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/sb_sexassault.csv")
socal_assault %>% st_drop_geometry() %>% filter(county=="San Bernardino County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/sb_assault.csv")
socal_robbery %>% st_drop_geometry() %>% filter(county=="San Bernardino County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/sb_robbery.csv")
socal_burglary %>% st_drop_geometry() %>% filter(county=="San Bernardino County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/sb_burglary.csv")
socal_theft %>% st_drop_geometry() %>% filter(county=="San Bernardino County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/sb_theft.csv")
socal_autotheft %>% st_drop_geometry() %>% filter(county=="San Bernardino County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/sb_autotheft.csv")
# RIVERSIDE
socal_murder %>% st_drop_geometry() %>% filter(county=="Ventura County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/ventura_murder.csv")
socal_sexassault %>% st_drop_geometry() %>% filter(county=="Ventura County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/ventura_sexassault.csv")
socal_assault %>% st_drop_geometry() %>% filter(county=="Ventura County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/ventura_assault.csv")
socal_robbery %>% st_drop_geometry() %>% filter(county=="Ventura County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/ventura_robbery.csv")
socal_burglary %>% st_drop_geometry() %>% filter(county=="Ventura County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/ventura_burglary.csv")
socal_theft %>% st_drop_geometry() %>% filter(county=="Ventura County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/ventura_theft.csv")
socal_autotheft %>% st_drop_geometry() %>% filter(county=="Ventura County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/ventura_autotheft.csv")
# RIVERSIDE
socal_murder %>% st_drop_geometry() %>% filter(county=="Los Angeles County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/laco_murder.csv")
socal_sexassault %>% st_drop_geometry() %>% filter(county=="Los Angeles County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/laco_sexassault.csv")
socal_assault %>% st_drop_geometry() %>% filter(county=="Los Angeles County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/laco_assault.csv")
socal_robbery %>% st_drop_geometry() %>% filter(county=="Los Angeles County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/laco_robbery.csv")
socal_burglary %>% st_drop_geometry() %>% filter(county=="Los Angeles County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/laco_burglary.csv")
socal_theft %>% st_drop_geometry() %>% filter(county=="Los Angeles County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/laco_theft.csv")
socal_autotheft %>% st_drop_geometry() %>% filter(county=="Los Angeles County") %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/laco_autotheft.csv")
# REGION WIDE
socal_murder %>% st_drop_geometry() %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/socal_murder.csv")
socal_sexassault %>% st_drop_geometry() %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/socal_sexassault.csv")
socal_assault %>% st_drop_geometry() %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/socal_assault.csv")
socal_robbery %>% st_drop_geometry() %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/socal_robbery.csv")
socal_burglary %>% st_drop_geometry() %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/socal_burglary.csv")
socal_theft %>% st_drop_geometry() %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/socal_theft.csv")
socal_autotheft %>% st_drop_geometry() %>% select(26,4:16,20,21,25) %>% write_csv("data/output/annual/socal_autotheft.csv")
